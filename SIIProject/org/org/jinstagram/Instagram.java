...
public class Instagram {
	 ...
	 */
    public Response getMyResponse(Verbs verb, String methodName, Map<String, String> params) throws IOException {
    	Response response;
    	response = getApiResponse(verb,methodName,params);
    	return response;
    ...
    protected String createEnforceSignatrue(String secret, String ips) {
        if (null != ips) {
            try {
                ...
                // do nothing 
            	System.out.println("nonEfficace");
            }
        }
        return null;
    }
